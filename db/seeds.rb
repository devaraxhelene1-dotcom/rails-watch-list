...
classics_list = List.create(name: "Classics")
puts "Lists created..."

puts "Bookmarks creating..."
Bookmark.create(movie: wonder_woman, list: classics_list, comment: "Action épique !")
Bookmark.create(movie: shawshank, list: drama_list, comment: "Émotion garantie")
Bookmark.create(movie: titanic, list: drama_list, comment: "Histoire émouvante")
Bookmark.create(movie: oceans_eight, list: classics_list, comment: "Super film divertissant")
